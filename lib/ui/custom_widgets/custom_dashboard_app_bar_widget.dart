...
class CustomDashboardAppBarWidget extends ConsumerStatefulWidget {
  const CustomDashboardAppBarWidget({
    Key? key,
  }) : super(key: key);

  @override
  ConsumerState<CustomDashboardAppBarWidget> createState() => _CustomDashboardAppBarWidgetState();

}

class _CustomDashboardAppBarWidgetState extends BaseConsumerState<CustomDashboardAppBarWidget> {
