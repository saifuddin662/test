...
class CustomTransactionSuccessfulBackgroundWidget extends CustomPainter {
  ...
  CustomTransactionSuccessfulBackgroundWidget({required this.bgColor, required this.borderColor});

  @override
  void paint(Canvas canvas, Size size) {
    final maxWidth = size.width;
    final maxHeight = size.height;
    final cutoutStartPos = maxHeight - maxHeight * 0.20;
  ...
  @override
  bool shouldRepaint(CustomTransactionSuccessfulBackgroundWidget oldDelegate) => false;

  @override
  bool shouldRebuildSemantics(CustomTransactionSuccessfulBackgroundWidget oldDelegate) => false;
}