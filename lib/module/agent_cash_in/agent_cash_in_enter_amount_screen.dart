...
import 'agent_cash_in_confirm_screen.dart';


class AgentCashInEnterAmountScreen extends ConsumerStatefulWidget {

  final String recipientName;
  final String recipientNumber;

  const AgentCashInEnterAmountScreen({
    super.key,
  ...
  @override
  ConsumerState<AgentCashInEnterAmountScreen> createState() => _AgentCashInEnterAmountScreenState();
}

class _AgentCashInEnterAmountScreenState extends BaseConsumerState<AgentCashInEnterAmountScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final minLimit = featureDetailsSingleton.feature[FeatureDetailsKeys.cashInFromMfsAgent]!.minLimit.toString();
    final maxLimit = featureDetailsSingleton.feature[FeatureDetailsKeys.cashInFromMfsAgent]!.maxLimit.toString();
    final featureIcon = featureDetailsSingleton.feature[FeatureDetailsKeys.cashInFromMfsAgent]?.imageUrl;
    final transactionType = featureDetailsSingleton.feature[FeatureDetailsKeys.cashInFromMfsAgent]?.transactionType;
