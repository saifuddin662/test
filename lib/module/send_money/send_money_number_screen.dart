...
import 'package:red_cash_dfs_flutter/module/send_money/send_money_enter_amount_screen.dart';
...
class SendMoneyNumberScreen extends ConsumerStatefulWidget {
  const SendMoneyNumberScreen({Key? key}) : super(key: key);

  @override
  ConsumerState<SendMoneyNumberScreen> createState() =>
      _SendMoneyNumberScreenState();
}

class _SendMoneyNumberScreenState
    extends BaseConsumerState<SendMoneyNumberScreen> {
        ...
        if (currentState.isLoading || currentState.isRefreshing) {
          ...
          if (currentState.value.userType == "CUSTOMER") {
            Navigator.push(
                context,
                MaterialPageRoute(
                    builder: (context) => SendMoneyEnterAmountScreen(
                        ...
                        suffixIcon: IconButton(
                          onPressed: () {
                            if (userNumberTextController.text.isNotEmpty) {
                              checkUser
                                  .checkUser(userNumberTextController.text);
                            } else {
