...
import '../../ui/custom_widgets/custom_red_dasboard_app_bar_widget.dart';
...
import 'home/red_home_screen.dart';


class RedDashboardScreen extends ConsumerStatefulWidget {
  const RedDashboardScreen({Key? key}) : super(key: key);

  @override
  ConsumerState<RedDashboardScreen> createState() => _RedDashboardState();
}
...
class _RedDashboardState extends BaseConsumerState<RedDashboardScreen> {
  double latitude = 0.0;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: ref.watch(indexProvider) == 0 ? PreferredSize(
            ...
            child: const CustomRedDashboardAppBarWidget()
        ) : null,
