...
import 'package:red_cash_dfs_flutter/module/ekyc/nid_scan/back/preview_nid_back.dart';
...
class NidBackScreen extends ConsumerStatefulWidget {
  const NidBackScreen({Key? key}) : super(key: key);

  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _NidBackScreenState();
}

class _NidBackScreenState extends BaseConsumerState {
  @override
                ...
                children: [
                  CameraButton(
                    callback: () async {
                      ...
                      final name = "${EKycConstants.tagNidBack}_${DateTime.now().millisecondsSinceEpoch.toString()}";
